    ...
    for (; ;) {
        ...
        switch (item.code) {
            ...
            case xCode.xcDashLength:
                ...
                break;
            default:
                console.assert(false, 'AcDbLinetypeTableRecord', item.code, item.value);
                break;
        }
    }
}
    ...
    for (; ;) {
        ...
        switch (item.code) {
            ...
            case xCode.xcPlotStyleNameId:
                break;
            default:
                console.assert(false, 'AcDbLayerTableRecord', item.code, item.value);
                break;
        }
    }
}
    ...
    for (; ;) {
        ...
        switch (item.code) {
            ...
            case xCode.xcXdInteger32:
                break;
            default:
                console.assert(false, 'AcDbTextStyleTableRecord', item.code, item.value);
                break;
        }
    }
}
    ...
    for (; ;) {
        ...
        switch (item.code) {
            ...
            case xCode.xcControlString:
                ...
                break;
            default:
                console.assert(false, 'AcDbBlockTableRecord', item.code, item.value);
                break;
        }
    }
}
        ...
        case 0:
            switch (halign) {
                ...
                case 5:
                    ...
                    break;
                default:
                    console.warn('text align undefined');
                    justify = TextAlignment.Left;
                    break;
            }
            break;
        ...
        while (true) {
            ...
            switch (value) {
                ...
                case 'ACDSDATA':
                    ...
                    break;
                default:
                    console.error(`Bad section ${value}`);
                    skepSection(reader);
                    break;
            }
        }
